...
#			if ( hasDup(a1, used1) == 0 ) goto else
			addi $a0, $sp, 152
			lw $a1, 148($sp)
			jal hasDup
			beq $v0, $0, else 
...
#			if ( exists(arrBegPtr + 1, numEle - 1, *arrBegPtr) == 0 ) goto endIf2
			sw $a0, 0($fp)
			sw $a1, 4($fp)
			addi $a0, $a0, 4
			addi $a1, $a1, -1
...
endIf3:
#			if (*arrBegPtr == target)
#			if (*arrBegPtr != target) goto endIf4
			lw $v1, 0($a0)
			bne $v1, $a2, endIf4
#			{
#			   return 1;
